...
import com.example.androidtvlibrary.main.adapter.player.DefaultControlDispatcher;
import com.example.androidtvlibrary.main.adapter.player.PlaybackPreparer;
import com.example.androidtvlibrary.main.adapter.player.PlayerControlView;
import com.example.androidtvlibrary.main.adapter.player.RepeatModeUtil;
...
public class PlayerView extends FrameLayout implements AdsLoaderTest.AdViewProvider {
    ...
    /**
     * The buffering view is shown when the player is in the {@link TestPlayer#STATE_BUFFERING buffering}
     * state and {@link TestPlayer#getPlayWhenReady() playWhenReady} is {@code true}.
     */
    public static final int SHOW_BUFFERING_WHEN_PLAYING = 1;
    /**
     * The buffering view is always shown when the player is in the {@link TestPlayer#STATE_BUFFERING
     * buffering} state.
     */
...
//    @Nullable private final SubtitleView subtitleView;
    ...
    @Nullable private ErrorMessageProvider<? super Exception> errorMessageProvider;
...
//        }
    ...
    /**
     * Switches the view targeted by a given {@link TestPlayer}.
     *
    ...
    public static void switchTargetView(
            TestPlayer player, @Nullable PlayerView oldPlayerView, @Nullable PlayerView newPlayerView) {
    ...
    /**
     * Set the {@link TestPlayer} to use.
     *
     * <p>To transition a {@link TestPlayer} from targeting one view to another, it's recommended to use
     * {@link #switchTargetView(TestPlayer, PlayerView, PlayerView)} rather than this method. If you do
     ...
     *
     * @param player The {@link TestPlayer} to use, or {@code null} to detach the current player. Only
    ...
    public void setPlayer(@Nullable TestPlayer player) {
        ...
        @Nullable TestPlayer oldPlayer = this.player;
        if (oldPlayer != null) {
            oldPlayer.removeListener(componentListener);
            @Nullable TestPlayer.VideoComponent oldVideoComponent = oldPlayer.getVideoComponent();
            ...
            @Nullable TestPlayer.TextComponent oldTextComponent = oldPlayer.getTextComponent();
...
//        }
        ...
        if (player != null) {
            @Nullable TestPlayer.VideoComponent newVideoComponent = player.getVideoComponent();
            ...
            @Nullable TestPlayer.TextComponent newTextComponent = player.getTextComponent();
     ...
     * media, the player transitioning to unprepared media, {@link TestPlayer#stop(boolean)} being called
    ...
    public void setErrorMessageProvider(
            @Nullable ErrorMessageProvider<? super Exception> errorMessageProvider) {
...
//    }
    ...
    private boolean shouldShowControllerIndefinitely() {
        ...
        return controllerAutoShow
                ...
                || playbackState == TestPlayer.STATE_ENDED
    ...
    private void updateBuffering() {
        if (bufferingView != null) {
            boolean showBufferingSpinner =
                    player != null
                            && player.getPlaybackState() == TestPlayer.STATE_BUFFERING
    ...
    private void updateErrorMessage() {
        if (errorMessageView != null) {
            ...
            @Nullable Exception error = player != null ? player.getPlaybackError() : null;
        ...
        if (controller == null || !useController) {
            ...
            setContentDescription(
                    /* contentDescription= */ controllerHideOnTouch
                            ? "R.string.exo_controls_hide"
                            : null);
        } else {
            setContentDescription(
                    /* contentDescription= */ "R.string.exo_controls_show");
        }
    }
    ...
    private final class ComponentListener
            implements TestPlayer.EventListener,
            TestPlayer.TextOutput,
            VideoListener,
...
//            }
        ...
        public void onTracksChanged(TrackGroupArray tracks, TrackSelectionArray selections) {
            ...
            TestPlayer player = Assertions.checkNotNull(PlayerView.this.player);
