 ...
 * setting an override isn't possible. Note that a { TestPlayer.EventListener} registered on the
...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class ParametersBuilder extends TrackSelectionParameters.Builder {
        ...
        private final SparseArray<Map<TrackGroupArray,  SelectionOverride>>
                selectionOverrides;
        ...
        private void setInitialValuesWithoutContext( ParametersBuilder this) {
            // Video
        ...
        private static SparseArray<Map<TrackGroupArray,  SelectionOverride>>
        cloneSelectionOverrides(
                SparseArray<Map<TrackGroupArray,  SelectionOverride>> selectionOverrides) {
            SparseArray<Map<TrackGroupArray,  SelectionOverride>> clone =
                    new SparseArray<>();
    ...
    public static final class Parameters extends TrackSelectionParameters {
        ...
        private static void writeSelectionOverridesToParcel(
            ...
            for (int i = 0; i < renderersWithOverridesCount; i++) {
                ...
                for (Map.Entry<TrackGroupArray,  SelectionOverride> override :
                        overrides.entrySet()) {
        ...
        private static boolean areSelectionOverridesEqual(
            ...
            for (Map.Entry<TrackGroupArray,  SelectionOverride> firstEntry :
                    first.entrySet()) {
    ...
    selectTracks(
        ...
        for (int i = 0; i < rendererCount; i++) {
            ...
            Log.e("aaaaaaLengs", String.valueOf(rendererTrackGroups.length));
     ...
     * @param rendererMixedMimeTypeAdaptationSupports The {@link RendererCapabilities.AdaptiveSupport} for mixed MIME type
     *     adaptation for the renderer.
     * @return The {@link TrackSelection.Definition}s for the renderers. A null entry indicates no
     *     selection was made.
     * @throws Exception If an error occurs while selecting the tracks.
     */
    ...
    protected static boolean isSupported(
             int formatSupport, boolean allowExceedsCapabilities) {
